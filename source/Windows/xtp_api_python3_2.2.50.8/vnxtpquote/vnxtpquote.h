...
#define ONQUERYALLNQTICKERSFULLINFO 31
#define ONTICKBYTICKLOSSRANGE 32
#define ONETFIOPVDATA 33
...
public:
	...
	void processTickByTickLossRange(Task *task);
	...
	void processETFIOPVData(Task *task);
	...
	void processQueryAllNQTickersFullInfo(Task *task);
