...
void QuoteApi::processDepthMarketData(Task *task)
{
    ...
    if (task->task_data)
    {
			...
			if ((task_data->data_type == XTP_MARKETDATA_ACTUAL) || (task_data->data_type_v2 == XTP_MARKETDATA_V2_ACTUAL)){
			...
			}else if ((task_data->data_type == XTP_MARKETDATA_OPTION) || (task_data->data_type_v2 == XTP_MARKETDATA_V2_OPTION)){
			...
			else if (task_data->data_type_v2 == XTP_MARKETDATA_V2_BOND)
			{
				...
				data["r2"] = task_data->bond.r2;
				data["r3"] = task_data->bond.r3;
